...
class usuario extends mysql
{
  ...
  public function cadastrar()
  {
    ...
    try {
      ...
      if (empty($consultaUsuario['email'])) {
        ...
        $this->cadastroGSheets($_POST['nome'], $_POST['email'], $_POST['cellphone'], $_POST['cnpj'], $_POST['faixa_quantidade'], $_POST['fbclid_input'], $_POST['utm_source_input'], $_POST['utm_medium_input'], $_POST['utm_campaign_input']);
  ...
  public function cadastroBancoApp($name, $email, $senha)
  {
    ...
    curl_setopt_array($curl, [
      CURLOPT_URL => $empresaAPIURL . "/auth/create/",
  ...
  public function cadastroGSheets($name, $email, $phone, $cnpj, $faixa_quantidade, $fbclid, $utm_source, $utm_medium, $utm_campaign)
  {
    $empresaGSheetsURLExec = DB_GSHEETS;


    $data = array("name" => $name, "email" => $email, "phone" => '+55 ' . $phone, "cnpj" => $cnpj, "faixa_quantidade" => $faixa_quantidade, "fbclid" => $fbclid, "utm_source" => $utm_source, "utm_medium" => $utm_medium, "utm_campaign" => $utm_campaign);
